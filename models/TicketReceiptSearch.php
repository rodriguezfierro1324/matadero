...
/**
 * TicketReceiptSearch represents the model behind the search form about `app\models\TicketReceipt`.
 */
class TicketReceiptSearch extends TicketReceipt
{
    /**
     * @inheritdoc
     */
