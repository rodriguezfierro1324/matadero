...
/**
 * TicketDispatchSearch represents the model behind the search form about `app\models\TicketDispatch`.
 */
class TicketDispatchSearch extends TicketDispatch
{
    /**
     * @inheritdoc
     */
